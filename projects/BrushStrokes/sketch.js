...
function gui_values(){
  const max_layers = working_palette.length - 2;
  parameterize("layers", round(random(1,max_layers)), 1, max_layers, 1, false);
...
function draw() {
  ...
  pop();
  if(type != "png"){
    stroke(working_palette[working_palette.length-1]);
