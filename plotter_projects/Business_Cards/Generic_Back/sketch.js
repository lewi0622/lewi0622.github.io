...
function gui_values(){
  ...
  parameterize("text_size", 50, 1, 500, 1, true);
  parameterize("x_loc", 23, -base_x, base_x, 1, true);
  parameterize("y_loc", 44, -base_y, base_y, 1, true);
  parameterize("x2_loc", 53, -base_x, base_x, 1, true);
  parameterize("y2_loc", 61, -base_y, base_y, 1, true);
  parameterize("x3_loc", -24, -base_x, base_x, 1, true);
  parameterize("y3_loc", 61, -base_y, base_y, 1, true);
}
...
function draw() {
  ...
  noFill();
  const line1 = font.getPath("Digital and Plotted Art", 0,0, text_size);
