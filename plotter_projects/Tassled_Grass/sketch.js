...
function grass(count, steps = 100){
  push();
  const branch_width = random(0.1, 0.3) * max_width * random([-1, 1]);
  const branch_height = -max_height * random(0.1,0.9);

  translate(random(0.4,0.6) * width, height - branch_height * 0.05);
